...
class PostCreatedRewardPoint extends Notification implements ShouldQueue
{
    use Queueable;
 /**
     * who made the Post.
    ...
    public function __construct($customer, $post, $reward)
    {
    ...
    public function toDatabase($notifiable): array
    {
        return [
            ...
            'type' => 'reward',
            'action' => 'post_create_reward_added',
        ];
    }
