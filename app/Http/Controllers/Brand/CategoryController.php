...
use App\Models\Brand\CategoryTranslation;
use App\Http\Controllers\Controller;
use App\Http\Resources\Brand\CategoryEditResource;
...
class CategoryController extends Controller
{
    ...
    public function index(Request $request, $locale)
    {
        ...
        $this->authorize('viewAny brand_category');
    ...
    public function getAll($locale)
    {
        ...
        $categories = DB::table('brand_categories as c')
            ->join('brand_category_translations as ct', 'c.id', '=', 'ct.category_id')
            ->select('c.id', 'ct.name')
    ...
    public function store($locale)
    {
        ...
        $this->authorize('create brand_category');
    ...
    public function update(Request $request, $locale, Category $category)
    {
        ...
        $this->authorize('update brand_category');

        $translation = DB::table('brand_category_translations')->where('category_id', '=', $category->id)->where('locale', '=', $locale)->first();
        $translation_id = null;
        if ($translation) {
        ...
        $this->validate($request, [
            'name' => 'required',
            'slug' => 'required|alpha_dash|unique:brand_category_translations,slug,' . $translation_id,
        ]);
    ...
    public function restoreTrashed(Request $request, $locale)
    {
        ...
        $this->authorize('restore brand_category');
    ...
    public function forceDelete(Request $request, $locale)
    {
        ...
        $this->authorize('forceDelete brand_category');
