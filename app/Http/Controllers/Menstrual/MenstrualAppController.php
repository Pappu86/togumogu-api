...
use App\Http\Resources\Menstrual\MenstrualAppResource;
use Illuminate\Support\Facades\Log;

class MenstrualAppController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => new MenstrualAppResource($menstrual)
            ]);
    ...
    /**
     * @return MenstrualAppResource|JsonResponse
     */
     public function getSingleMenstrualInfo(): MenstrualAppResource|JsonResponse
     {
        try {
            $customerId = Auth::id();
