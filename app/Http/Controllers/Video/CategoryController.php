...
use App\Models\Video\CategoryTranslation;
use App\Http\Controllers\Controller;
use App\Http\Resources\Video\CategoryEditResource;
...
class CategoryController extends Controller
{
    ...
    public function index(Request $request, $locale)
    {
        ...
        $this->authorize('viewAny video_category');
    ...
    public function getAll($locale)
    {
        ...
        $categories = DB::table('video_categories as c')
            ->join('video_category_translations as ct', 'c.id', '=', 'ct.category_id')
            ->select('c.id', 'ct.name')
    ...
    public function store($locale)
    {
        ...
        $this->authorize('create video_category');
    ...
    public function update(Request $request, $locale, Category $category)
    {
        ...
        $this->authorize('update video_category');

        $translation = DB::table('video_category_translations')->where('category_id', '=', $category->id)->where('locale', '=', $locale)->first();
        $translation_id = null;
        if ($translation) {
        ...
        $this->validate($request, [
            'name' => 'required',
            'slug' => 'required|alpha_dash|unique:video_category_translations,slug,' . $translation_id,
        ]);
    ...
    public function restoreTrashed(Request $request, $locale)
    {
        ...
        $this->authorize('restore video_category');
    ...
    public function forceDelete(Request $request, $locale)
    {
        ...
        $this->authorize('forceDelete video_category');
